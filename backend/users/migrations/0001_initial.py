# Generated by Django 3.2.6 on 2022-10-18 08:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=50, unique=True, validators=[users.validations.validate_username], verbose_name='Логин')),
                ...
                ('role', models.TextField(choices=[('admin', 'admin'), ('user', 'user')], default='user', max_length=5, verbose_name='Роль')),
